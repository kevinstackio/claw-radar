...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      className={cn(
        "group relative z-[1200] flex w-px cursor-col-resize items-center justify-center overflow-visible bg-border/80 transition-[background-color] duration-150 hover:bg-sky-500/70 group-hover:bg-sky-500/70 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1",
        "before:pointer-events-none before:absolute before:left-1/2 before:top-0 before:h-full before:w-px before:-translate-x-1/2 before:bg-border/80 before:content-[''] before:transition-[width,height,background-color] before:duration-150",
        "hover:before:w-[2px] hover:before:bg-sky-500/70 group-hover:before:w-[2px] group-hover:before:bg-sky-500/70",
    ...
    >
      {withHandle ? (
        <div
          className={cn(
            "z-[1300] flex h-6 w-4 items-center justify-center rounded-sm border-2 border-border/80 bg-background/95 shadow-sm transition-colors group-hover:border-sky-500/70 group-hover:bg-background",
            handleClassName
          )}
        >
